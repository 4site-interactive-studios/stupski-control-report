...
**Prepared by:** 4Site Interactive Studios
...
The report is designed to be presented to Glen Galaich and the Stupski leadership team. It uses the Stupski brand identity, including the Apotek Variable typeface from the CONTROL landing page, and is structured around the phased promo timeline that was coordinated between 4Site and Claire Callahan.
...
- **Font:** Headers use Apotek Variable loaded from `stupski.org/wp-content/themes/stupski/assets/fonts/39CDB8_2_0.woff2`. Falls back to DM Serif Display → Georgia → serif if the font can't load.
- **Body font:** DM Sans loaded from Google Fonts.
- **Charts:** Built with Recharts (React charting library).
- **Framework:** React component (`.jsx`) designed to render in Claude.ai's artifact viewer or any React environment.

---

## Hosting on GitHub Pages

This report is designed to be hosted on GitHub Pages for easy client access.

### Setup

1. Create a new repository on GitHub (private recommended for client data)
2. Upload `index.html` and `README.md` to the root of the repository
3. Go to **Settings → Pages**
4. Set Source to **Deploy from a branch**, Branch: `main`, Folder: `/ (root)`
5. Click Save — your report will be live at `https://[username].github.io/[repo-name]/`

### Sharing with the Client

- **Private repo:** Add the client as a collaborator (Settings → Collaborators) so they can access the GitHub Pages URL
- **Public repo:** Simply share the Pages URL — anyone with the link can view it

### Updating the Report

1. Export fresh data from GA4, GSC, and Clarity using the instructions below
2. Update the `DAILY` data array and static data objects in `index.html`
...
| File | Description |
|---|---|
| `index.html` | The standalone dashboard for GitHub Pages (self-contained, no build step) |
| `stupski-control-report.jsx` | The React component source (for use in Claude.ai artifacts) |
| `README.md` | This file — report documentation and update guide |
